...
bool HelloWorld::init()
{
	...
	Director::getInstance()->getTextureCache()->addImageAsync("texture/home_textrue.png",
		CC_CALLBACK_1(HelloWorld::loadingTextureCallBack, this));

	Director::getInstance()->getTextureCache()->addImageAsync("texture/setting_textrue.png",
		CC_CALLBACK_1(HelloWorld::loadingTextureCallBack, this));

	Director::getInstance()->getTextureCache()->addImageAsync("texture/gameplay_textrue.png",
		CC_CALLBACK_1(HelloWorld::loadingTextureCallBack, this));
...
void HelloWorld::loadingTextureCallBack(Texture2D *texture)
{
	...
	{
	case 0:
		SpriteFrameCache::getInstance()->addSpriteFramesWithFile("texture/home_textrue.plist",texture);
		log("home textrue ok.");
		break;
	case 1:
